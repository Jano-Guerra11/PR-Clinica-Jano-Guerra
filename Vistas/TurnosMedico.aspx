...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style3">
            <asp:GridView ID="grdTurnos" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CssClass="auto-style4" OnSelectedIndexChanged="grdTurnos_SelectedIndexChanged" OnRowDataBound="grdTurnos_RowDataBound" OnRowCancelingEdit="grdTurnos_RowCancelingEdit" OnRowEditing="grdTurnos_RowEditing" OnRowUpdating="grdTurnos_RowUpdating">
                <Columns>
