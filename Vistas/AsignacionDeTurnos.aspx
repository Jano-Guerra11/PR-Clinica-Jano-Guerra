...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style2">
            <tr>
                <td>ESPECIALIDAD:          <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvEspecialidad" runat="server" ControlToValidate="ddlEspecialidad" ForeColor="Red" InitialValue="0" ValidationGroup="3">*</asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
                <td>
        ...
        <table class="auto-style6">
            ...
            <tr>
                <td class="auto-style8">
                    <asp:Button ID="btnBuscar" runat="server" Text="Buscar DNI" OnClick="btnBuscar_Click" />
                </td>
        ...
        <asp:GridView ID="grdTurnos" runat="server" AutoGenerateColumns="False" OnRowDataBound="grdTurnos_RowDataBound" AutoGenerateDeleteButton="True" OnRowDeleting="grdTurnos_RowDeleting">
            <Columns>
